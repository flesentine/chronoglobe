...
function desktopOnly(testInfo) {
  test.skip(testInfo.project.name !== 'desktop-chromium', 'Second hinted result resume test runs once on desktop Chromium');
}
...
test('a completed round three after the second hint resumes without double counting', async ({ page }, testInfo) => {
